...
write_csv(steam_df, "data/clean_steam_games.csv")
```
...
With our cleaned dataset, we can proceed to [Exploratory Data Analysis](eda.html) to find the correlations of our interest.