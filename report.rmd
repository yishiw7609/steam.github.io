...
Genres encapsulate game design choices, and identifying which genres drive deeper engagement is important for game developers. Below we list the top 20 most played genres on Steam.
...
correlation = steam_df |>
  ...
  select(price, estimated_owners, release_date,
         peak_ccu, average_playtime, median_playtime,
         dlc_count, positive, negative) |>
