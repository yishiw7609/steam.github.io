...
From the correlation matrix and other plots, we find `peak_ccu` and most variables are weak linearly. Therefore, instead of performing a Linear Regression, we use a Random Forest regressor to handle relationships and interactions.
